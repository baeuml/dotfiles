...
awful.rules.rules = {
    ...
    { rule = { class = "Konsole" },  properties = { floating = false } },
    { rule = { class = "MPlayer" },  properties = { floating = true } },
    { rule = { class = "pinentry" }, properties = { floating = true } },
    { rule = { class = "gimp" },     properties = { floating = true } },
    { rule = { name = "okapi-viewer" }, properties = { floating = true } },
    { rule = { class = "Firefox" }, properties = { floating = false } }, --   properties = { tag = tags[1][2] } },
    { rule = { class = "Git-gui" },
